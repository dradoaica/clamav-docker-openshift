...
docker build -t dradoaica/clamav-openshift:1.5.4 -f Dockerfile .

## Push clamav-docker-openshift

docker push dradoaica/clamav-openshift:1.5.4

## Run clamav-docker-openshift container

docker run -p 0.0.0.0:3310:3310/tcp --name clamav-openshift -d dradoaica/clamav-openshift:1.5.4
...
docker rmi dradoaica/clamav-openshift:1.5.4
